...
st.write("From the heatmap, we can see that Pahang has strong correlation with all of the state except W.P Kuala Lumpur and W.P Putrajaya. Among the strong corelation states, W.P Labuan, Terengganu, Sarawak, Sabah, Perak, Melaka, Kelantan and Johor have a strong"
 "corelation as their corelation coefficient value is more than 0.9. For the top four states are Terengganu, Sabah, Kelantan and W.P Labuan. "
 "We will choose the top four states as for the 3rd position there are two states have the same corelation coefficient value 0.97 which is Kelantan and W.P Labuan.")

st.write("For Johor, we can see that it has strong corelation within all the states as all the correlation coefficient value are more than 0.7. "
"But among the strong corelation state, we can see that Kedah, Kelantan, Melaka, Negeri Sembilan, Pahang, Perak, Perlis, Sabah and Terengganu "
"have a much higher correlation coefficient value which is more than 0.9.  The top three states are the Melaka, Negeri Sembilan and Perak.")

# QUESTION 3iii
st.markdown('# Features and Indicators')
st.write("Put your explanation here")
...
st.write("As conclusion, the overall performance of the classification model will be better in predicting the daily"
         ...
         " accuracy score compared to the regression models."
)
