...
#pass
st.write('The confusion matrix of the KNN is:')
#if st.checkbox('Confusion Matrix of KNN'):
st.text(confusion_majority)
#pass
st.write('The classification report of the KNN is:')
...
#
st.write('The confusion matrix of the Decision Tree Classifier is:')
#if st.checkbox('Confusion Matrix of Decision Tree Classifier'):
st.text(confusion_majority)
#pass
st.write('The classification report of the Decision Tree Classifier is:')
...
st.markdown('### Comparison for Model Evaluation of Classification Models')
st.text('')
...
i#f st.checkbox('RMSE of Linear Regression'):
